...
def fetch_quotes(symbols):
    all_data = []
    for i in range(0, len(symbols), 10):  # Fyers allows 10 symbols max per call
        ...
        try:
            ...
            if res.get("s") == "ok":
                ...
                print(f"⚠️ API error for batch {batch}: {res}")
...
def option_chain():
    expiry = "24J18"  # Update weekly as needed
